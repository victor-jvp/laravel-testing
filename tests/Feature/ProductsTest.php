...
class ProductsTest extends TestCase
{
    ...
    public function test_homepage_containts_empty_table()
    {
    ...
    public function test_homepage_containts_non_empty_table()
    {
    ...
    public function test_product_update_validation_errors_redirects_back_to_form()
    {
        $product = Product::factory()->create();
